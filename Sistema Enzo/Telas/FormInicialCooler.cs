...
{
    public partial class FormInicialCooler : Form
    {
        public int contador = 0;
        public FormInicialCooler()
        {
            InitializeComponent();
        }
        ...
        private void btn_avancar_Click(object sender, EventArgs e)
        {
            ...
            {
                Program.componentes[7] = 349.99.ToString("C2");
            }
            else if (selecionada == check_2.Name)
            {
                Program.componentes[7] = 150.00.ToString("C2");
            }
            else if (selecionada == check_3.Name)
            {
                Program.componentes[7] = 89.99.ToString("C2");
            }
            else if (selecionada == check_4.Name)
            {
                Program.componentes[7] = 183.43.ToString("C2");
            }
            else if (selecionada == check_5.Name)
            {
                Program.componentes[7] = 519.99.ToString("C2");
            }
            else if (selecionada == check_6.Name)
            {
                Program.componentes[7] = 959.99.ToString("C2");
            }
            else if (selecionada == check_7.Name)
            {
                Program.componentes[7] = 999.99.ToString("C2");
            }
            else if (selecionada == check_8.Name)
            {
                Program.componentes[7] = 1289.99.ToString("C2");
            }
