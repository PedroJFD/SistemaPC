...
{
    public partial class TelaInicialPlacaVideo : Form
    {
        public int contador = 0;
        public TelaInicialPlacaVideo()
        {
            InitializeComponent();
        }
        ...
        private void btn_avancar_Click(object sender, EventArgs e)
        {
            ...
            {
                Program.componentes[3] = 2199.99.ToString("C2");
            }
            else if (selecionada == check_2.Name)
            {
                Program.componentes[3] = 4899.99.ToString("C2");
            }
            else if (selecionada == check_3.Name)
            {
                Program.componentes[3] = 2499.99.ToString("C2");
            }
            else if (selecionada == check_4.Name)
            {
                Program.componentes[3] = 1199.99.ToString("C2");
            }
            else if (selecionada == check_5.Name)
            {
                Program.componentes[3] = 1699.99.ToString("C2");
            }
            else if (selecionada == check_6.Name)
            {
                Program.componentes[3] = 5999.90.ToString("C2");
            }
            else if (selecionada == check_7.Name)
            {
                Program.componentes[3] = 9499.99.ToString("C2");
            }
            else if (selecionada == check_8.Name)
            {
                Program.componentes[3] = 11099.99.ToString("C2");
            }
        ...
        {
            TelaInicialMemoriaRAM tela = new TelaInicialMemoriaRAM();
            this.Visible = false;
            tela.ShowDialog();
        }
    }
