...
{
    public partial class TelaInicialPlacaMae : Form
    {
        public int contador = 0;
        public TelaInicialPlacaMae()
        {
            InitializeComponent();
        }
        ...
        private void btn_avancar_Click(object sender, EventArgs e)
        {
            ...
            {
                Program.componentes[1] = 3219.90.ToString("C2");
            }
            else if (selecionada == check_2.Name)
            {
                Program.componentes[1] = 1239.00.ToString("C2");
            }
            else if (selecionada == check_3.Name)
            {
                Program.componentes[1] = 889.99.ToString("C2");
            }
            else if (selecionada == check_4.Name)
            {
                Program.componentes[1] = 722.50.ToString("C2");
            }
            else if (selecionada == check_5.Name)
            {
                Program.componentes[1] = 1199.99.ToString("C2");
            }
            else if (selecionada == check_6.Name)
            {
                Program.componentes[1] = 1499.00.ToString("C2");
            }
            else if (selecionada == check_7.Name)
            {
                Program.componentes[1] = 3680.00.ToString("C2");
            }
            else if (selecionada == check_8.Name)
            {
                Program.componentes[1] = 979.00.ToString("C2");
            }
